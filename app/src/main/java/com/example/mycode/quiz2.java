...
public class quiz2 extends AppCompatActivity {
    ...
    private final quiz2QuestionLibrary mQuestionLibrary = new quiz2QuestionLibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Code to Text: Letters");
    ...
    private void showBottomSheet(){
        ...
        newQuizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openQuizzes = new Intent(quiz2.this, Quizzes.class);
