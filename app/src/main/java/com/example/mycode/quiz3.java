...
public class quiz3 extends AppCompatActivity {
    ...
    private final quiz3QuestionLibrary mQuestionLibrary = new quiz3QuestionLibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Text to Code: Punctuation");
    ...
    private void showBottomSheet(){
        ...
        newQuizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openQuizzes = new Intent(quiz3.this, Quizzes.class);
