...
public class quiz5 extends AppCompatActivity {
    ...
    private final quiz5QuestionLibrary mQuestionLibrary = new quiz5QuestionLibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Text to Code: Numbers");
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(quiz5.this);
        ...
        newQuizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openQuizzes = new Intent(quiz5.this, Quizzes.class);
