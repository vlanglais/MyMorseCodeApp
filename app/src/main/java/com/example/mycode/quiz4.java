...
public class quiz4 extends AppCompatActivity {
    ...
    private final quiz4QuestionLibrary mQuestionLibrary = new quiz4QuestionLibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Code to Text: Punctuation");
    ...
    private void showBottomSheet(){
        ...
        newQuizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openQuizzes = new Intent(quiz4.this, Quizzes.class);
    ...
    //When 8 questions attempted, score appears
