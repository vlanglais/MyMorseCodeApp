...
public class quiz6 extends AppCompatActivity {
    ...
    private final quiz6QuestionLibrary mQuestionLibrary = new quiz6QuestionLibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Code to Text: Numbers");
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(quiz6.this);
        ...
        newQuizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openQuizzes = new Intent(quiz6.this, Quizzes.class);
    ...
    //When 10 questions attempted, score appears
